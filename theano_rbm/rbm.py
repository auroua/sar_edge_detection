...
class RBM(object):
    ...
    def get_cost_updates(self, lr=0.1, persistent=None, k=1):
        ...
        :param lr: learning rate RBMused to train the RBM
...
def test_rbm(learning_rate=0.001, training_epochs=15,
    ...
    # # add 2016-8-10
    # o_train_set_x = numpy.load('data/mnist_train_data_28.npy')
